...
class Tooltk(object):
	...
	def initial_frames(self):
		...
		# s = ttk.Style()
		# s.configure('TScrollbar', foreground='maroon',height=10)
	...
	def read_help(self):
		if self.helppath is not None:
			filename = os.path.join(GUIpath.Docs_p,self.helppath)
...
class SingleFileBlock(object):
	...
	def single_file_block(self, sfb_name):
		...
		# Entry
		self.__newEntry = newGUI.NeewwEntry(
